    ...
    return(
        <div className="h-full w-full flex justify-center items-center">
                <div className="h-[50%] w-[90%] bg-slate-400 rounded-lg text-slate-50 shadow-2xl shadow-slate-950  flex flex-col items-center justify-around  ">
                    ...
                    <div className="flex justify-between w-[80%] h-[10%] text-lg "><button className="h-full w-[30%] px-5 rounded-lg bg-sky-500">Continue</button><button className="h-full w-[30%] px-5 rounded-lg bg-red-400">Cancel</button></div>
                </div>
        </div>
    )
}